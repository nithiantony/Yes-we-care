...
{
$ret=mysql_query("SELECT * FROM tbl_login WHERE username='".$_POST['username']."' and password='".$_POST['password']."' and role='3'");
$num=mysql_fetch_array($ret);
if($num>0)
{
$extra="dashboard.php";//
$_SESSION['ulogin']=$_POST['username'];
$_SESSION['id']=$num['user_id'];//echo $_SESSION['id'];die();
